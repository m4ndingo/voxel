...
"""Rescata las capturas que el dueño adjunta en el chat y las deja en data/tickets/<ID>/.
    ...
    python3 herramientas/guardar_imagenes_ticket.py BUG-GAL1   # las del último mensaje con imágenes
    python3 herramientas/guardar_imagenes_ticket.py BUG-GAL1 --uuid ded1fb70
    python3 herramientas/guardar_imagenes_ticket.py --listar   # qué mensajes con imágenes hay

Se lanza desde la RAÍZ del repo, como el resto: escribe en data/tickets/ y ésa cuelga de la raíz.
